// ---------- CONFIG OPENROUTER ----------
const OPENROUTER_API_KEY = "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";
          ...
          messages: [
            {
              role: "system",
              content: `
              Kamu adalah Ubot, asisten resmi Universitas Klabat (UNKLAB).

              Gunakan HANYA informasi dari database UNKLAB berikut sebagai sumber jawaban:

              ${JSON.stringify(UNKLAB_DATA, null, 2)}

              ATURAN:
              1. Jangan menjawab di luar data JSON ini.
              2. Jangan mengarang atau menebak.
              3. Jika pertanyaan tidak ada dalam data: jawab
                "Maaf, informasi tersebut tidak tersedia dalam data UNKLAB."
              4. Gunakan bahasa Indonesia yang singkat dan sopan.
`
            },
